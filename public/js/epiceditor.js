...
(function (window, undefined) {
    ...
    _HtmlTemplates = {
      ...
      chrome:   '<div id="epiceditor-wrapper" class="epiceditor-edit-mode">' +
                  ...
                  '<div id="epiceditor-utilbar">' +
                    '<img width="30" src="' + this.settings.basePath + '/img/preview.png" title="Toggle Preview Mode" class="epiceditor-toggle-btn epiceditor-toggle-preview-btn"> ' +
                    '<img width="30" src="' + this.settings.basePath + '/img/edit.png" title="Toggle Edit Mode" class="epiceditor-toggle-btn epiceditor-toggle-edit-btn"> ' +
                    '<img width="30" src="' + this.settings.basePath + '/img/fullscreen.png" title="Enter Fullscreen" class="epiceditor-fullscreen-btn">' +
                  '</div>' +
                '</div>'
  ...
  EpicEditor.prototype.preview = function (theme) {
    ...
    /**
   * will call the send callback
   */
  EpicEditor.prototype.send = function () {
    var self = this;
    self.settings.send_callback(_getText(self.editor));
  }
  ...
  EpicEditor.prototype.empty = function (name) {
    var self = this;
    _setText(self.editor, '');
    return this;
  }
  ...
  EpicEditor.prototype.getContent = function (name) {
    var self = this;
    _setText(self.editor, '');
    return this;
  }
